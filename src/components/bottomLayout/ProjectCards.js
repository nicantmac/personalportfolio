const cardData = [
    ...
    },
    {
        ...
        status: "In-progress",
        link: "https://github.com/nicantmac",
        desc: "A platform that people can use to add there job application-process details and the system " +
            "predicts and outputs the likeliness of being ghosted by a company. If ghosted, the system uses " +
            "ML model to take corresponding data i.e. situation, company details, your info etc to " +
    ...
    },
    {
        ...
        desc: "AI-powered resume optimization tool that analyzes resumes against job descriptions. Identifies missing keywords, weak bullet points, and ATS compatibility issues. Provides actionable suggestions and before/after comparisons using GPT-4. Built after applying to 500+ jobs to help others avoid common resume mistakes."
    },
    {
        title: "IoTPort - Smart Home Dashboard",
    ...
    },
    {
        ...
        desc: "Tech salary research platform aggregating compensation data from public sources. Filter by role, location, experience level, and company size. Visualize salary ranges with interactive charts and compare multiple offers side-by-side. Built to solve the pain of researching 100+ salary ranges during job search."
    },
    {
        ...
        desc: "Web-based API testing tool for developers. Test REST endpoints, save request collections, manage environment variables, and export requests as code (fetch, axios, curl). Features JSON/XML response formatting and syntax highlighting. Lightweight alternative to Postman for quick API testing."
    },
];
